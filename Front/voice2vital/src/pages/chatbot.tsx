  ...
  const simulateBotResponse = (userMessage: string) => {
    ...
    setTimeout(() => {
      ...
      if (lowerMessage.includes('hello') || lowerMessage.includes('hi')) {
        botResponse = `Hello Dr. ${user.surname || 'Doctor'}! I'm ready to help you with any medical documentation or clinical questions you might have.`;
      } else if (lowerMessage.includes('patient') || lowerMessage.includes('diagnosis')) {
        botResponse = 'I can help you with patient documentation, differential diagnosis suggestions, or clinical decision support. What specific case would you like to discuss?';
      } else if (lowerMessage.includes('medication') || lowerMessage.includes('drug')) {
        botResponse = 'I can assist with medication information, drug interactions, dosage calculations, and prescription guidelines. What medication query do you have?';
      } else if (lowerMessage.includes('symptom')) {
        botResponse = 'I can help analyze symptoms and suggest possible conditions to consider. Please describe the symptoms you\'d like to discuss.';
      } else if (lowerMessage.includes('help')) {
        botResponse = 'I can assist with:\n• Clinical documentation\n• Differential diagnosis\n• Medication guidance\n• Symptom analysis\n• Medical calculations\n• Treatment protocols\n\nWhat would you like help with?';
      } else {
        botResponse = 'That\'s an interesting question! While I\'m designed to help with medical and clinical matters, I\'d be happy to assist you with patient care, documentation, or any medical queries you might have.';
      }
